...
import com.example.savingdatalocalusingroom.databinding.ActivityMainBinding
import com.example.savingdatalocalusingroom.databinding.DialogUpdateBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.btnAdd?.setOnClickListener {
            // TODO call add record with employeeDao, we need to create an employee app class wit Applcation(), and also need to add that clas in manifest file
    ...
    fun addRecord(employeeDao: EmployeeDao) {
        ...
        if (name.isNotEmpty() && email.isNotEmpty()) {
            ...
            Toast.makeText(applicationContext, "Email or Name cannot be null", Toast.LENGTH_LONG)
                .show()
        }
    }
